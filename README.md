...
**ENDEAVOUR**
Endeavour - My [EndeavourOS](https://github.com/endeavouros-team) post-install script. This script is **probably deprecated**, since I havent used EdeavourOS for quite some time.
